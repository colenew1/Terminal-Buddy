import { IS_MAC, shortcutLabel } from '../lib/shortcuts'
...
const STEPS = [
  ...
  { title: 'Start with the plus', icon: '+', target: '.tab-new', text: 'The + opens a chooser. Start a plain terminal, launch a new Claude or Codex chat, pick a project folder, or resume a saved chat.', tip: shortcutLabel('New windows start from your home folder. Nothing launches until you choose. Shortcut: Ctrl+Shift+T.') },
  { title: 'One place to type', icon: '>_', target: '.cell.is-active .cell-body', text: 'Click directly in the terminal and type. Enter, arrow keys, yes/no choices, trust prompts, and agent slash commands all go straight to the real terminal.', tip: IS_MAC ? 'Paste with Cmd+V and copy a selection with Cmd+C. Control+C interrupts the running program.' : 'No separate chat composer. Paste with Ctrl+V; Ctrl+C copies a selection or interrupts when nothing is selected.' },
